...
<c:url value="/chinguyen/users/records?_search=false" var="recordsUrl"/>
<c:url value="/chinguyen/users/create" var="addUrl"/>
<c:url value="/chinguyen/users/update" var="editUrl"/>
<c:url value="/chinguyen/users/delete" var="deleteUrl"/>
